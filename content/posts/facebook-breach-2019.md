...
- ไฟล์ในชุดผสมมีการปรากฎของไฟล์ที่มีการใช้วิธีการบีบอัดที่แตกต่างกับไฟล์ที่ปรากฎใน `f.zip` ซึ่งสามารถแยกออกเป็น 2 กลุ่มตามวิธีในการบีบอัด ได้แก่กลุ่มที่มีการใช้ Zip ในการบีบอีด และกลุ่มที่มีการใช้ 7-zip ในการบีบอัด ดังนี้
...
- บางรายการของไฟล์บีบอีดในชุดของไฟล์ข้อมูลแบบผสมมีการจัดเก็บไฟล์เอกสารไว้มากกว่าหนึ่งไฟล์ด้วย ซึ่งแตกต่างจากกรณีของไฟล์ `f.zip` ทีประกอบไปด้วยไฟล์เอกสารเพียงไฟล์เดียวที่ถูกบีบอัดเอาไว้อยู่ อาทิ
