...
การวิเคราะห์มัลแวร์เรียกค่าไถ่ REvil ของ [Intel471](https://intel471.com/blog/revil-ransomware-as-a-service-an-analysis-of-a-ransomware-affiliate-operation) ระบุถึงการใช้ไลบรารีที่เกี่ยวข้องกับการเข้ารหัสของ REvil อยู่สองไลบรารี ไลบรารีหนึ่งเป็นไลบรารีของ [Curve25519](https://github.com/vstakhov/opt-cryptobox/tree/master/curve25519) ตรงกัน อีกไลบรารีหนึ่งเป็นของอัลกอริธึม [Salsa20](https://cr.yp.to/snuffle.html) แบบ [merged](https://cr.yp.to/snuffle/salsa20/merged/salsa20.c) ที่มีการใส่โค้ดแบบ inline ของ Salsa20 core เอาไว้ อย่างไรก็ตามดูเหมือนว่าโค้ดที่ถูกเอามาใช้ในการอิมพลีเมนต์นั้นจะมาจากโค้ดแบบ [ref](https://cr.yp.to/snuffle/salsa20/ref/salsa20.c) มากกว่า
