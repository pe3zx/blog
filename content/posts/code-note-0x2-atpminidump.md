...
```c
typedef NTSTATUS(NTAPI *_RtlGetVersion) (LPOSVERSIONINFOEXW lpVersionInformation);
```
...
อย่างไรก็ตาม การทำความเข้าใจเพียงเท่านี้ยังเป็นการทำความเข้าใจเพียงแค่ครึ่งเดียวจากโค้ดทั้งหมดครับ :)
