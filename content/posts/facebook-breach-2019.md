...
- ไฟล์บางอย่างซึ่งอยู่ในชุดของข้อมูลที่อ้างว่ามีการรั่วไหลออกมามี timestamp การถูกแก้ไขก่อนช่วงเวลาที่มีการรายงานการพบข้อมูลในครั้งแรก ซึ่งทำให้แหล่งที่มาและลำดับเวลาไม่สอดคล้องกัน โดยเฉพาะอย่างไฟล์ `Bahrain.txt`